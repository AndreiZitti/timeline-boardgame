...
_A collection of party games for your next game night_
...
| Tool | Description |
|------|-------------|
| **Score Tracker** | Track scores for Septica, Whist, and Rentz |
...
```bash
# Clone
git clone https://github.com/AndreiZitti/games.zitti.git
cd games.zitti
